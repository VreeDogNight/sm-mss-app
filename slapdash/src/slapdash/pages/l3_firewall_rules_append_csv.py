...
layout = html.Div([
    html.Div([
        html.H2('Firewall Rules Append - Firewall Technicians'),
    ...
    html.Div([
        html.Div([
            ...
            dcc.Input(
                id='input-box-1_l3_firewall_rules_append_csv',
                type='text',
        ...
        html.Div([
            ...
            dcc.Input(
                id='input-box-2_l3_firewall_rules_append_csv',
                type='text',
                placeholder='API Key',
                value='')
        ], style={'margin-top': 30}),
        ...
        html.Div([
            html.Button('Search', id='general_search_l3_firewall_rules_append_csv')
            ], style={'margin-top': 30})], className='ten columns offset-by-one'),

    html.Div(id='table_l3_firewall_rules_append_csv', className='ten columns offset-by-one', style={'margin-top': 30}),
    html.Div(id='intermediate-value_l3_firewall_rules_append_csv', style={'display': 'none'})
])
...
# Callbacks
@app.callback(output=Output('intermediate-value_l3_firewall_rules_append_csv', 'children'),
    inputs=[Input('general_search_l3_firewall_rules_append_csv', "n_clicks")],
    state=[State('input-box-1_l3_firewall_rules_append_csv', "value"), State('input-box-2_l3_firewall_rules_append_csv', "value")]
)
...
@app.callback(Output('table_l3_firewall_rules_append_csv', 'children'), [Input('intermediate-value_l3_firewall_rules_append_csv', 'children')])
                ...
                return html.Div([
                        html.Div([
                            dash_table.DataTable(
                                id='datatable-interactivity_l3_firewall_rules_append_csv',
                                columns=[
                        ...
                        html.Div([
                            html.Div(id='display_selected_row_l3_firewall_rules_append_csv', className='ten columns offset-by-one', style={'margin-top': 30})
                        ]),
                    ])
...
@app.callback(
    output=Output('display_selected_row_l3_firewall_rules_append_csv', "children"),
    inputs=[Input('datatable-interactivity_l3_firewall_rules_append_csv', "selected_rows")],
    state=[State('intermediate-value_l3_firewall_rules_append_csv', 'children'), State('datatable-interactivity_l3_firewall_rules_append_csv', "data")])
        ...
        if selected_rows == []:
            ...
            if len(selected_rows) > 1:
                return html.Div([
                            html.Div(
                                dash_table.DataTable(
                                    id='display_selected_row_data_table_l3_firewall_rules_append_csv',
                                    columns=[
                                        {"name": i, "id": i} for i in networks.columns
                                    ],
                            ...
                            html.Div(
                                html.Div([
                                    dcc.Upload(
                                        id='upload-data_l3_firewall_rules_append_csv',
                                        children=html.Div([
                                            'Drag and Drop or ',
                                            html.A('Select Files')
                                        ]),
                                    ...
                                    html.Div(id='output-data-upload_l3_firewall_rules_append_csv'),
                                    html.H3('If these are the networks that you would like to append the L3 firewall rules to, please press "Submit" after selecting the .csv file conntaining the rules.'),
                                    html.Div(
                                        html.Button('Submit', id='specific_search_l3_firewall_rules_append_csv')
                                    ),
                                    html.Div(html.H4(id='output-container-button_l3_firewall_rules_append_csv'), style={'margin-top': 15})
                                ])
                ...
                return html.Div([
                            ...
                            html.Div(
                                html.Div([
                                    ...
                                    html.Div(id='output-data-upload_l3_firewall_rules_append_csv'),
                                    html.H3('If this is the network that you would like to append the L3 firewall rules to, please press "Submit" after selecting the .csv file conntaining the rules.'),
                                    html.Div(
                                        html.Button('Submit', id='specific_search_l3_firewall_rules_append_csv')
                                    ),
                                    html.Div(html.H4(id='output-container-button_l3_firewall_rules_append_csv'), style={'margin-top': 15})
...
@app.callback(Output('output-data-upload_l3_firewall_rules_append_csv', 'children'),
              [Input('upload-data_l3_firewall_rules_append_csv', 'contents')],
              [State('upload-data_l3_firewall_rules_append_csv', 'filename')])
...
@app.callback(
    Output('output-container-button_l3_firewall_rules_append_csv', 'children'),
    [Input('specific_search_l3_firewall_rules_append_csv', 'n_clicks')],
    state=[
        State('datatable-interactivity_l3_firewall_rules_append_csv', "selected_rows"),
        State('intermediate-value_l3_firewall_rules_append_csv', 'children'),
        State('input-box-2_l3_firewall_rules_append_csv', "value"),
        State('upload-data_l3_firewall_rules_append_csv', 'contents'),
        State('upload-data_l3_firewall_rules_append_csv', 'filename'),
    ])
            ...
            if type(file_data) == str:
                ...
                try:
                    for row in rows:
                        ...
                        updated_rule_set = ((meraki_l3_pull_current_rules_df_start.append(file_data)).append(meraki_l3_pull_current_rules_df_last)).reset_index(drop=True)
                        ...
                        data_record_stats = '{"date_time":"' + date_time_record_stats + '", "group":"Firewall Technician", "time_saved":"' + time_saved + '", "note":"Appending new Meraki L3 Firewall Rules to selected network."}'
                ...
                app.logger.debug(('The L3 Firewall rules for the location(s) {} have had the rules from the file {} appended to the current ruleset. A backup has been made of the new ruleset(s) as well.').format(list_specific_network_name, (file_name[0])))

                app.logger.debug('##################################################')

                return ('The L3 Firewall rules for the location(s) "{}" have had the rules from the file {} appended to the current ruleset. A backup has been made of the new ruleset(s) as well.').format(list_specific_network_name, (file_name[0]))
